...
class TestView(TestCase):
  ...
  def test_get_settings(self):
    ...
    self.assertEqual(response.templates[0].name, 'nabmastodond/settings.html')
  ...
  def test_post_connect(self):
    ...
    self.assertEqual(config.redirect_uri, 'http://10.10.10.42/nabmastodond/oauthcb')
  ...
  def test_delete_connect(self):
    ...
    config.spouse_pairing_date = datetime.datetime(2018, 11, 11, 11, 11, 11, tzinfo=tzutc())
