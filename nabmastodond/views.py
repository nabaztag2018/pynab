...
class ConnectView(View):
    def post(self, request, *args, **kwargs):
        ...
        redirect_location = (location.scheme, location.netloc, reverse('nabmastodond.oauthcb'), '', '', '')
        redirect_uri = urlunparse(redirect_location)
        if config.instance != request.POST['instance'] or config.redirect_uri != redirect_uri:
